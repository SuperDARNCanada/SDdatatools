...
class EmptyDataFileWarning(Warning):
    ...
    def __init__(self, data_file):
        self.data_filename = date_file
        self.message = "Data file {} is Empty, will not be used in the gridding process".format(self.data_filename)
        Warning.__init__(self, self.message)
...
class FileNotFoundWarning(Warning):
    ...
    def __init__(self, data_file):
        self.data_filename = date_file
        self.message = "Data file {} does not exist, will not be used in the convection map process".format(self.data_filename)
        Warning.__init__(self, self.message)
